...
def rsslesen(feed,aus):
    ...
    """
    WEG=['title_detail', 'summary_detail', 'content', 'published', 'guidislink','links', 'id',
         'updated','dc_format','rights','rights_detail','language','publisher',
         'publisher_detail','dc_identifier','dc_subjects','dcterms_audience',
         'dcterms_isformatof','tags','updated_parsed','link']
    #übrige: 
